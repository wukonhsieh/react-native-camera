...
@interface RNPhotoCaptureDelegate ()
...
@property (nonatomic) void (^completed)(RNPhotoCaptureDelegate *photoCaptureDelegate);

@end

@implementation RNPhotoCaptureDelegate

- (instancetype)initWithRequestedPhotoSettings:(AVCapturePhotoSettings *)requestedPhotoSettings willCapturePhotoAnimation:(void (^)())willCapturePhotoAnimation completed:(void (^)(RNPhotoCaptureDelegate *))completed
{
  self = [super init];
  if (self) {
                                 ...
                                 error:(NSError *)error
{
  ...
  self.takenImage = [UIImage imageWithData:(NSData*)self.jpegPhotoData];
