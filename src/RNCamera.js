...
export default class Camera extends React.Component<PropsType, StateType> {
  static Constants = {
    ...
    PictureSizes: CameraManager.PictureSizes,
    CameraStatus,
  };
  ...
  static propTypes = {
    ...
    exposureBias: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  ...
  async getExposureOffset() {
    return await CameraManager.exposureOffset(this._cameraHandle);
  }
